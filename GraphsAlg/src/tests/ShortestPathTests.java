...
import static graphalgorithms.GraphAlgorithms.*;
...
public class ShortestPathTests {
	...
	public void SimplestTest() {
		...
		List<graph.IGraph.Edge<IWeight>> expected = new ArrayList<>();
	...
	public void MediumGraphTest() {
		...
		List<graph.IGraph.Edge<IWeight>> actual = ShortestPath(g, "A", "Z");
		printLists(actual);
	...
	private static double findPathSum(List<graph.IGraph.Edge<IWeight>> list) {
		double sum = 0.0;
		for (graph.IGraph.Edge<IWeight> edge : list) {
	...
	private static void printLists(List<graph.IGraph.Edge<IWeight>> list1) {
		double sum = 0;
		for (graph.IGraph.Edge<IWeight> edge : list1) {
