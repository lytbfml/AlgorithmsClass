...
public class _GraphProcessorTest {
	...
	public void sameComponent() {
		...
		assertFalse(g.sameComponent("Aren't you a little young to build a rollercoaster?",
		                            "Why yes, yes I am."));
	}
	...
	public void bfsPath() {
		...
		assertArrayEquals(emptyList, actual);
		actual = g.bfsPath("All you did was hang around and eat our eggs.", "A").toArray(
				new String[0]);
		assertArrayEquals(emptyList, actual);
		actual = g.bfsPath("I expected something more grand, less...", "...fuzzy.").toArray(
				new String[0]);
		assertArrayEquals(emptyList, actual);
	}
